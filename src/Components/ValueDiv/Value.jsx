      ...
      <div className="grid gap-[10rem] grid-cols-3 items-center">
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
          <div className="imgDiv p-[4px] rounded-[.8rem] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
            <img src="/src/assests/logo4.png" alt="" className="" />
          </div>
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#a2a2a2] p-[1.5rem]">
          <div className="imgDiv p-[4px] rounded-[.8rem] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
            <img src="/src/assests/logo7.jpg" alt="" className="" />
          </div>
          <span className="font-semibold text-textColor text-[18px]">
            Valentines
          </span>
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#fcfae3] p-[1.5rem]">
          <div className="imgDiv p-[4px] rounded-[.8rem] bg-inherit-[#dedef8] h-[40px] w-[40px] flex items-center justify-center">
            <img src="/src/assests/logo6.jpg" alt="" className="" />
          </div>
          <span className="font-semibold text-textColor text-[18px]">
            Simplicity
          </span>
